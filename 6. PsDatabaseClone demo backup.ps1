...
$fileStructure = New-Object System.Collections.Specialized.StringCollection
    $fileStructure.Add('/opt/sqlserver/testdatabase_clone_BEPGY/data/testdatabase.mdf')
    $filestructure.Add('/opt/sqlserver/testdatabase_clone_BEPGY/log/testdatabase_log.ldf')
